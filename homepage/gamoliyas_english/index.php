...
<html>
    <head>
        <title>Gamoliyas &copy; (by Joan Alba Maldonado)</title>
        <!-- (c) Gamoliyas - Program by Joan Alba Maldonado (granvino@granvino.com). Prohibited to publish, reproduce or modify without maintain author's name. -->
        ...
        <!--
                ...
                function actualizar_panel()
                {
                    ...
                    var es_estable = estable ? "yes" : "no";
                    if (estable && ciclos_estable >= 0) { es_estable = "yes (at " + ciclos_estable + " cycles)"; }
                    var esta_extinta = extinta ? "[Extinct]" : "[Living]";
                ...
                function seleccionar_boton(boton, borde)
                {
                    ...
                    if (!juego_pausado) { document.getElementById("boton_pause").style.border = "1px solid #00aa00"; } //Si el juego no esta pausado, elimina su seleccion.
                    document.getElementById("boton_stop").style.border = "1px solid #00aa00";
                    document.getElementById("boton_increment_speed").style.border = "1px solid #00aa00";
                    document.getElementById("boton_decrement_speed").style.border = "1px solid #00aa00";
                    document.getElementById("boton_random_draw").style.border = "1px solid #00aa00";
                    if (mundo_esferico) { document.getElementById("boton_spherical_world").style.border = "1px solid #556655"; } else { document.getElementById("boton_spherical_world").style.border = "1px solid #00aa00"; }
                    ...
                    document.getElementById("boton_open_world").style.border = "1px solid #00aa00";
                    document.getElementById("boton_save_world").style.border = "1px solid #00aa00";
                    ...
                    if (boton != "")
                    {
                        ...
                        if (juego_pausado && boton.id == "boton_pause") { return; }
                        ...
                        if (se_ha_comenzado || !se_ha_comenzado && boton.id != "boton_pause") {  boton.style.border = borde + "px solid " +  borde_color; }
                        ...
                        if (!se_ha_comenzado && boton.id == "boton_pause") { document.getElementById("etiqueta_boton").style.color = "#556655"; }
                ...
                function abrir_guardar_mundo(accion)
                {
                    ...
                    if (accion == "guardar" && se_ha_comenzado)
                    {
                        ...
                        {
                            juego_pausado = true;
                            seleccionar_boton(document.getElementById('boton_pause'), 2);
                            parar_ciclos();
                            mostrar_mensaje('Pause')
                        }
                    }

                    //Cambia el titulo del dialogo:
                    if (accion == "guardar") { document.getElementById("abrir_guardar_titulo").innerHTML = "Save world"; }
                    else { document.getElementById("abrir_guardar_titulo").innerHTML = "Open world"; }
                    
                    //Cambia el value y el title del boton del dialogo:
                    if (accion == "guardar") { document.getElementById("boton_abrir_guardar").title = "Generate URL"; document.getElementById("boton_abrir_guardar").value = "Generate URL"; }
                    else { document.getElementById("boton_abrir_guardar").title = "Open"; document.getElementById("boton_abrir_guardar").value = "Open world"; }
                ...
                function abrir_guardar_procesar()
                {
                    ...
                    if (document.getElementById("abrir_guardar_titulo").innerHTML == "Save world") { generar_url(); }
                ...
                function modificar_tablero()
                {
                    ...
                    var errores = "";
                    if (isNaN(tablero_ancho_enviado) || tablero_ancho_enviado < tablero_ancho_minimo || tablero_ancho_enviado > tablero_ancho_maximo) { errores += "Board width must be a number between " + tablero_ancho_minimo + " and " + tablero_ancho_maximo + "<br>"; }
                    if (isNaN(tablero_alto_enviado) || tablero_alto_enviado < tablero_alto_minimo || tablero_alto_enviado > tablero_alto_maximo) { errores += "Board height must be a number between " + tablero_alto_minimo + " and " + tablero_alto_maximo + "<br>"; }
                    ...
                    {
                        //Muestra el error:
                        mostrar_alerta("<h2>This errors have happened:</h2>" + errores);
                    ...
                    else
                    {
                        ...
                        mostrar_mensaje("Creating board...");
                ...
                function se_ha_enviado_tablero(url)
                {
                    ...
                    if (speed_url != "" && speed_url > 0)
                    {
                        ...
                        else { errores += "Speed must be a number between " + ciclos_milisegundos_minimo + " and " + ciclos_milisegundos_maximo + "<br>"; }
                    }
                    ...
                    if (cellwidth_url != "" && cellwidth_url > 0)
                    {
                        ...
                        //...pero si no, guarda su error:
                        else { errores += "Cell width must be a number between " + celda_ancho_minimo + " and " + celda_ancho_maximo + "<br>"; }
                    }
                    //Si se ha enviado un ancho de celda:
                    if (cellheight_url != "" && cellheight_url > 0)
                    {
                        ...
                        //...pero si no, guarda su error:
                        else { errores += "Cell height must be a number between " + celda_alto_minimo + " and " + celda_alto_maximo + "<br>"; }
                    }
                    //Si se ha enviado un ancho de celda:
                    if (cellpadding_url != "" && cellpadding_url > 0)
                    {
                        ...
                        //...pero si no, guarda su error:
                        else { errores += "Cell spacing must be a number between " + celda_espaciado_minimo + " and " + celda_espaciado_maximo + "<br>"; }
                    }
                    //Comprueba si se han enviado bien o no los demas datos para guardar su error si no:
                    if (tablero_ancho_url > 0 && tablero_ancho_url != "" && (isNaN(tablero_ancho_url) || tablero_ancho_url < tablero_ancho_minimo || tablero_ancho_url > tablero_ancho_maximo)) { errores += "Board width must be a number between " + tablero_ancho_minimo + " and " + tablero_ancho_maximo + "<br>"; }
                    if (tablero_alto_url > 0 && tablero_alto_url != "" && (isNaN(tablero_alto_url) || tablero_alto_url < tablero_alto_minimo || tablero_alto_url > tablero_alto_maximo)) { errores += "Board height must be a number between " + tablero_alto_minimo + " and " + tablero_alto_maximo + "<br>"; }
                    ...
                    if (spherical_url != "" && spherical_url != "0" && spherical_url != 0) { mundo_esferico = true; document.getElementById("boton_spherical_world").style.border = '1px solid #556655'; }
    ...
    <body onLoad="pagina_cargada = false; setTimeout('juego_bloqueado = false; pagina_cargada = true; iniciar_juego_primera_vez();', 10);" onMouseUp="campo_seleccionable = false; pintar = false; borrar = false; arrastrando_objeto = false;" onClick="campo_seleccionable = false; arrastrando_objeto = false;" onMouseMove="if (pagina_cargada) { arrastrar(event); }" onKeyPress="tecla_pulsada(event, 'onkeypress');" onKeyDown="tecla_pulsada(event, 'onkeydown');" onKeyUp="pintar = false; borrar = false;" onMouseMove="if (pagina_cargada) { arrastrar(event); }" bgcolor="#99aa99" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        <div id="menu_superior" style="visibility:hidden; position:absolute; left:30px; top:10px; padding:0px; height:20px; background:transparent; color:#003300; text-align:left; line-height:20px; text-decoration:none; font-weight:none; font-family:arial; font-size:12px; cursor:pointer; cursor:hand; z-index:3;">
            <form style="display:inline;" onSubmit="modificar_tablero(); return false;" align="center">
                <center>
                    ...
                    <label for="tablero_x" style="line-height:12px; font-size:12px; font-weight:bold; cursor:pointer; cursor:hand;" accesskey="x" title="Board width">
                    ...
                    &nbsp;&nbsp;
                    <label for="tablero_y" style="line-height:12px; font-size:12px; font-weight:bold; cursor:pointer; cursor:hand;" accesskey="y" title="Board height">
                    ...
                    &nbsp;
                    <input type="submit" value="OK" name="boton_aplicar" style="height:18px; color:#005500; font-weight:bold; text-align:center; line-height:9px; font-size:9px; font-family:verdana; cursor:pointer; cursor:hand;" accesskey="o" title="Apply options">
                </center>
            </form>
            ...
            <div id="boton_increment_speed" style="position:absolute; left:210px; top:1px; width:26px; height:20px; background:url('img/boton.gif'); border:1px solid #00aa00; color:#005500; font-weight:bold; text-align:center; line-height:16px; font-size:16px; font-family:arial; cursor:pointer; cursor:hand; -moz-user-select:none;" title="" onMouseOver="seleccionar_boton(this, 1);" onMouseOut="seleccionar_boton('', 1); modificar_velocidad_ciclos(0, true);" onMouseDown="modificar_velocidad_ciclos(-1, true);" onMouseUp="modificar_velocidad_ciclos(0, true);" onClick="modificar_velocidad_ciclos(-1, false);" onSelectStart="return false;">-</div>
            <div id="velocidad_ciclos" style="position:absolute; left:242px; top:1px; width:65px; height:20px; background:url('img/boton.gif'); border:1px solid #00aa00; color:#005500; font-weight:bold; text-align:center; line-height:16px; font-size:16px; font-family:arial; cursor:default;" title="Milliseconds between cycles">500</div>
            <div id="boton_decrement_speed" style="position:absolute; left:313px; top:1px; width:26px; height:20px; background:url('img/boton.gif'); border:1px solid #00aa00; color:#005500; font-weight:bold; text-align:center; line-height:16px; font-size:16px; font-family:arial; cursor:pointer; cursor:hand; -moz-user-select:none;" title="" onMouseOver="seleccionar_boton(this, 1);" onMouseOut="seleccionar_boton('', 1); modificar_velocidad_ciclos(0, true);" onMouseDown="modificar_velocidad_ciclos(1, true);" onMouseUp="modificar_velocidad_ciclos(0, true);" onClick="modificar_velocidad_ciclos(1, false);" onSelectStart="return false;">+</div>
                    <!-- </div> -->
            <div id="boton_spherical_world" style="position:absolute; left:390px; top:1px; width:26px; height:20px; background:url('img/boton.gif'); border:1px solid #00aa00; color:#005500; font-weight:bold; text-align:center; line-height:16px; font-size:16px; font-family:arial; z-index:1; cursor:pointer; cursor:hand;" title="" onMouseOver="seleccionar_boton(this, 1);" onMouseOut="seleccionar_boton('', 1);" onClick="mundo_esferico = !mundo_esferico; this.style.border = '1px solid #556655'; if (multicolor) { mostrar_mensaje('Changing colors...'); setTimeout('transformar_colores(); mostrar_mensaje(\'\');', 10); }">
            ...
            <div id="boton_save_world" style="position:absolute; left:552px; top:1px; width:26px; height:20px; background:url('img/boton.gif'); border:1px solid #00aa00; color:#005500; font-weight:bold; text-align:center; line-height:16px; font-size:16px; font-family:arial; z-index:1; cursor:pointer; cursor:hand;" title="" onMouseOver="seleccionar_boton(this, 1);" onMouseOut="seleccionar_boton('', 1);" onClick="abrir_guardar_mundo('guardar');">
        ...
        <div id="alerta" style="visibility:hidden; background:#aaccaa; color:#aa0000; left:235px; top:125px; width:444px; height:240px; padding:0px; position:absolute; font-size:18px; font-style:normal; font-weight:bold; line-height:20px; text-align:center; filter:alpha(opacity=80); opacity:0.8; -moz-opacity:0.8; -khtml-opacity:0.8; -moz-user-select:none; cursor:crosshair; z-index:15;" onMouseUp="campo_seleccionable = false; arrastrando_objeto = false;" onMouseDown="if (campo_seleccionable) { campo_seleccionable = false; arrastrando_objeto = false; } else { arrastrando_objeto = this; arrastrando_objeto.sombra = 'alerta_sombra'; };" onSelectStart="return false;" onClick="if (document.getElementById('alerta').style.visibility == 'visible') { document.getElementById('formulario_alerta').boton_alerta.focus(); }">
            ...
            <div style="position:absolute; left:0px; top:200px; width:430px; height:30px;">
                <form style="display:inline;" id="formulario_alerta" onSubmit="if (juego_bloqueado) { mostrar_mensaje('Loading...'); setTimeout('iniciar_juego(true); mostrar_mensaje(\'\');', 10); } document.getElementById('alerta').style.visibility = 'hidden'; document.getElementById('alerta_sombra').style.visibility = 'hidden'; return false;" align="center">
                    <center><input type="submit" value="Ok" name="boton_alerta" style="height:24px; color:#aa0000; font-weight:bold; text-align:center; line-height:12px; font-size:12px; font-family:arial; cursor:pointer; cursor:hand; -moz-user-select:none;" accesskey="a" onSelectStart="return false;" title="Close window"></center>
                </form>
            </div>
        </div>
            ...
            <div style="width:640px; text-align:center;">
                <form style="display:inline; font-family:verdana; font-size:12px; font-weight:normal;" id="formulario_alerta" onSubmit="abrir_guardar_procesar(); return false;" align="center">
                    <center>
                        ...
                        <br>
                        <label for="abrir_guardar_reproducir_automaticamente" accesskey="r" style="cursor:pointer; cursor:hand;"><input type="checkbox" name="abrir_guardar_reproducir_automaticamente" id="abrir_guardar_reproducir_automaticamente"> Automatic play</label>
                        <br>
                        <label for="abrir_guardar_mundo_esferico" accesskey="e" style="cursor:pointer; cursor:hand;"><input type="checkbox" name="abrir_guardar_mundo_esferico" id="abrir_guardar_mundo_esferico"> Spherical world</label>
                        <br>
                        ...
                        <br>
                        <label for="abrir_guardar_esconder_menu_superior" accesskey="s" style="cursor:pointer; cursor:hand;"><input type="checkbox" name="abrir_guardar_esconder_menu_superior" id="abrir_guardar_esconder_menu_superior"> Hide top menu</label>
                        <br>
                        <label for="abrir_guardar_esconder_menu_inferior" accesskey="i" style="cursor:pointer; cursor:hand;"><input type="checkbox" name="abrir_guardar_esconder_menu_inferior" id="abrir_guardar_esconder_menu_inferior"> Hide bottom controls</label>
                        <br>
                        <label for="abrir_guardar_esconder_informacion" accesskey="c" style="cursor:pointer; cursor:hand;"><input type="checkbox" name="abrir_guardar_esconder_informacion" id="abrir_guardar_esconder_informacion"> Hide bottom information panel</label>
                        <br>
                        <label for="abrir_guardar_impedir_pintar" accesskey="p" style="cursor:pointer; cursor:hand;"><input type="checkbox" name="abrir_guardar_impedir_pintar" id="abrir_guardar_impedir_pintar"> Don't allow to draw</label>
                        <br>
                        Milliseconds between cycles: <input type="text" id="abrir_guardar_velocidad" name="abrir_guardar_velocidad" style="border:1px #00aa00 solid; color:#002200; background:#aaddaa; font-weight:bold; text-align:center; line-height:12px; font-size:12px; font-family:arial; cursor:text;" accesskey="v" onMouseDown="campo_seleccionable = true;" onMouseUp="campo_seleccionable = false;" size="5" maxlength="5">
                        <br>
                        Cell width: <input type="text" id="abrir_guardar_celda_ancho" name="abrir_guardar_celda_ancho" style="border:1px #00aa00 solid; color:#002200; background:#aaddaa; font-weight:bold; text-align:center; line-height:12px; font-size:12px; font-family:arial; cursor:text;" accesskey="c" onMouseDown="campo_seleccionable = true;" onMouseUp="campo_seleccionable = false;" size="3" maxlength="3">
                        <br>
                        Cell height: <input type="text" id="abrir_guardar_celda_alto" name="abrir_guardar_celda_alto" style="border:1px #00aa00 solid; color:#002200; background:#aaddaa; font-weight:bold; text-align:center; line-height:12px; font-size:12px; font-family:arial; cursor:text;" accesskey="o" onMouseDown="campo_seleccionable = true;" onMouseUp="campo_seleccionable = false;" size="3" maxlength="3">
                        <br>
                        Cell spacing: <input type="text" id="abrir_guardar_celda_espaciado" name="abrir_guardar_celda_espaciado" style="border:1px #00aa00 solid; color:#002200; background:#aaddaa; font-weight:bold; text-align:center; line-height:12px; font-size:12px; font-family:arial; cursor:text;" accesskey="e" onMouseDown="campo_seleccionable = true;" onMouseUp="campo_seleccionable = false;" size="3" maxlength="3">
                        </div>
                        Generated URL:
                        <br>
                        ...
                        <br>
                        <input type="submit" value="Generate URL" id="boton_abrir_guardar" name="boton_abrir_guardar" style="height:24px; color:#aa0000; font-weight:bold; text-align:center; line-height:12px; font-size:12px; font-family:arial; cursor:pointer; cursor:hand; -moz-user-select:none;" accesskey="a" onSelectStart="return false;" title="Generate URL">
                        <br>
                    </center>
                </form>
           </div>
        ...
        <div id="panel" style="left:30px; top:40px; width:160px; height:50px; visibility:visible; position:absolute; border:0px; padding:0px; background:#009900; color:#333333; text-align:center; line-height:50px; text-decoration:none; font-family:verdana; font-size:10px; z-index:1;">
            ...
            <img src="img/pausa.gif" id="boton_pause" style="position:absolute; left:60px; top:5px; width:40px; height:40px; border:1px solid #00aa00; cursor:pointer; cursor:hand; z-index:2;" title="" onClick="if (se_ha_comenzado) { if (!juego_pausado) { juego_pausado = true; seleccionar_boton(document.getElementById('boton_pause'), 2); parar_ciclos(); mostrar_mensaje('Pause'); } else { juego_pausado = false; mostrar_mensaje(''); comenzar_ciclos(ciclos_milisegundos); } }" onMouseOver="seleccionar_boton(this, 2);" onMouseOut="seleccionar_boton('', 2);">
            <img src="img/stop.gif" id="boton_stop" style="position:absolute; left:110px; top:5px; width:40px; height:40px; border:1px solid #00aa00; cursor:pointer; cursor:hand; z-index:2;" title="" onClick="juego_pausado = false; se_ha_comenzado = false; seleccionar_boton('', 2); parar_ciclos(); mostrar_mensaje('Creating board...'); setTimeout('crear_tablero(); mostrar_mensaje(\'\');', 10);" onMouseOver="seleccionar_boton(this, 2);" onMouseOut="seleccionar_boton('', 2);">
        </div>
        <!-- Fin de Panel. -->
        <!-- Etiqueta que describe la accion del boton: -->
        <span id="etiqueta_boton" style="position:absolute; left:0px; top:0px; height:12px; visibility:hidden; background:transparent; color:#002200; font-family:arial; font-size:12px; line-height:12px; font-weight:bold; cursor:default; z-index:3;">Loading...</span>
        ...
        <div id="panel2" style="left:190px; top:40px; height:50px; visibility:visible; position:absolute; border:0px; padding:0px; background:url('img/boton.gif'); color:#333333; text-align:center; line-height:50px; text-decoration:none; font-family:verdana; font-weight:bold; font-size:12px; z-index:1;">
            &nbsp;&nbsp;&nbsp; Stable: <span id="estable">yes</span>
            &nbsp; Population: <span id="poblacion">0</span> <span id="estado_poblacion">[Extinct]</span>
            &nbsp; Cycles: <span id="ciclos">0</span>
            &nbsp;&nbsp;&nbsp;
            <span id="autor" style="position:absolute; left:2px; top:20px; color:#116611; background:transparent; font-family:arial; font-size:9px; font-weight:normal;">Gamoliyas &copy; by Joan Alba Maldonado</span>
        </div>
        <!-- Fin de Panel 2. -->
        <!-- Informacion: -->
        <div id="informacion" style="left:10px; top:490px; height:0px; position:absolute; border:0px; padding:0px; background:transparent; color:#333333; text-align:left; line-height:20px; text-decoration:none; font-family:verdana; font-size:9px; z-index:3;">
            &copy; <b>Gamoliyas</b> 0.12a by <i>Joan Alba Maldonado</i> (<a href="mailto:granvino@granvino.com">granvino@granvino.com</a>) &nbsp;<sup>(DHTML 100%)</sup> &nbsp; <span onclick="if (document.getElementById('ayuda').style.display != 'block') { document.getElementById('ayuda').style.display = 'block'; this.title='Hide help'; } else { document.getElementById('ayuda').style.display = 'none'; this.title='Show help'; }" onMouseOver="this.style.fontWeight='bold'; this.style.color='#000000';" onMouseOut="this.style.fontWeight='normal'; this.style.color='#333333';" style="cursor:pointer; cursor:hand;" title="Show help">[?]</span>
            <span id="ayuda" style="display:none;">
                <br>&nbsp;&nbsp; To draw, use left mouse button or one of this keys: Shift, Return, Space.
                <br>&nbsp;&nbsp; To erase, use right mouse button (not in Opera) or keys Control, Backspace,
                <br>&nbsp;&nbsp; Delete, D, E or 0. Also, you can erase with double click.
                <br>&nbsp;&nbsp; To see how to use the game inside other pages, see this <a href="ejemplo.php" target="_blank">example</a>.
            </span>
